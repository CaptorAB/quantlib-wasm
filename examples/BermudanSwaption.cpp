...
int main(int, char *[])
{
    ...
    try
    {
        ...
        for (i = 0; i < numRows; i++)
        {
            ...
            swaptions.push_back(ext::shared_ptr<BlackCalibrationHelper>(new SwaptionHelper(swaptionMaturities[i],
        ...
        {
            auto swe = new G2SwaptionEngine(modelG2, 6.0, 16);
            swaptions[i]->setPricingEngine(ext::shared_ptr<PricingEngine>(swe));
        }
